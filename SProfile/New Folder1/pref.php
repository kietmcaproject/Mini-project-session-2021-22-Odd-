...
if($USN !=''||$email !='')
{
	if($USN == $sun)
    {
    if($query = mysqli_query("INSERT INTO `details`.`basicdetails` ( `FirstName`, `LastName`, `USN`, `Mobile`, `Email`, `DOB`, `Sem`, `Branch`, `SSLC`, `PU/Dip`, `BE`, `Backlogs`, `HofBacklogs`, `DetainYears`, `Approve`) 
...
if($USN !=''||$email !='')
{
	...
	$sql = mysqli_query("SELECT * FROM `details`.`basicdetails` WHERE `USN`='$USN'");
