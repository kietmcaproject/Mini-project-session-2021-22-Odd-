...
export default class Education extends Component {
    ...
    continue = e => {
        ...
        catch(e)
        {
          ...
          var {exp1_org,exp1_pos,exp1_dur,exp1_desc,exp2_org,exp2_pos,exp2_dur,exp2_desc,proj1_title,proj1_link,proj1_desc,proj2_title,proj2_link,proj2_desc,edu1_year,edu1_school,edu1_qualification,edu1_desc,edu2_year,edu2_school,edu2_qualification,edu2_desc} = this.props.values
        axios.post("/save/education",{user,sch_yr_qual_desc:[`${edu1_year},${edu1_school},${edu1_qualification},${edu1_desc}`,`${edu2_year},${edu2_school},${edu2_qualification},${edu2_desc}`],inst_pos_dur_desc:[`${exp1_org},${exp1_pos},${exp1_dur},${exp1_desc}`,`${exp2_org},${exp2_pos},${exp2_dur},${exp2_desc}`],proj_title_url_desc:[`${proj1_title},${proj1_link},${proj1_desc}`,`${proj2_title},${proj2_link},${proj2_desc}`]}).then(data=>{
